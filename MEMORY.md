...
- ✅ **PDF saía "lavado" (2026-05-31)** — o navegador descarta cores de fundo na impressão. Corrigido com `print-color-adjust: exact` (universal, no `@media print` do `globals.css`). Agora capa escura, selos, faixa da tabela, círculos numerados e **barras do gráfico** aparecem no PDF. Bruno: "tá ficando lindo". (Opcional futuro: capa full-bleed sem a margem branca.)
